...
describe('custom 11ty filters', () => {
  ...
  describe('wordCount', () => {
    ...
    it('returns word count for longer sentences', () => {
      expect(wordCount(`Hello, World. My name's Necip.`)).toEqual(5);
    });
    ...
    it(`returns the latest item.data.lastUpdated date`, () => {
      const posts = [
        { title: 'Item 1', date: '2021-04-20' },
        {
          title: 'Item 2',
          date: '2021-04-21',
          data: { lastUpdated: '2021-05-20' },
        },
        {
          title: 'Item 3',
          date: '2021-01-01',
          data: { lastUpdated: '2021-08-11' },
        },
      ];
    ...
    it(`returns the latest item.date`, () => {
      const posts = [
        { title: 'Item 1', date: '2021-01-02' },
        {
          title: 'Item 2',
          date: '2020-04-20',
          data: { lastUpdated: '2021-01-01' },
        },
        {
          title: 'Item 3',
          date: '2020-04-08',
          data: { lastUpdated: '2020-12-31' },
        },
      ];
